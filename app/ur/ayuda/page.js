  ...
  return (
    <div className="container ayuda-page-wrapper">
      ...
      <section className="ayuda-hero-section">
        <div className="ayuda-badge-pill">
          <span>🏛️ فاؤنڈیشن ایودا انٹرنیشنل (Ayuda Internacional)</span>
          <span className="badge-divider">•</span>
          <span>📖 کتاب: صدائےِ خلق (17 صفحات)</span>
        </div>

        <h1 className="ayuda-main-title">
          فاؤنڈیشن ایودا انٹرنیشنل اور کتاب <span className="highlight-text">"صدائےِ خلق"</span>
        </h1>
        
        <p className="ayuda-author-line">
          مصنفہ و بانی: <strong>محترمہ نصرت فاطمہ نقوی</strong> (وکیلِ انسانیت) — چیئرپرسن فاؤنڈیشن ایودا انٹرنیشنل
        </p>

        <p className="ayuda-hero-description">
          کتاب "صدائےِ خلق" انسانیت کے وقار، تفرقہ بازی کے خاتمے، اور حقیقی اسلام کے نورانی چہرے کو دنیا بھر میں روشناس کرانے کی ایک مخلصانہ پکار ہے۔ اسی فکری بنیاد پر فاؤنڈیشن "ایودا انٹرنیشنل" نے دنیا کے مختلف خطوں میں بے مثال فلاحی و رفاہی تاریخ رقم کی ہے۔
        </p>

        {/* ایکشن بٹنز بشمول پی ڈی ایف */}
        <div className="ayuda-action-buttons">
          <a
            href="#book-reader"
            className="btn-primary-golden"
            title="کتاب کا آن لائن مطالعہ کریں"
          >
            <span className="btn-icon">📖</span>
            <span>آن لائن کتاب کا مطالعہ کریں (ریڈر)</span>
          </a>
          ...
          <a
            ...
            title="اصل پی ڈی ایف فائل ڈاؤن لوڈ کریں"
          >
            <span className="btn-icon">📥</span>
            <span>پی ڈی ایف ڈاؤن لوڈ کریں (522 KB)</span>
          </a>

          <a href="#services-milestones" className="btn-secondary-outline">
            <span className="btn-icon">📜</span>
            <span>تاریخ ساز خدمات کی فہرست دیکھیں</span>
          </a>

          <a href="#cemetery-vision" className="btn-secondary-outline">
            <span className="btn-icon">⚰️</span>
            <span>ماڈل قبرستان کا وژن</span>
          </a>
        </div>
      </section>
