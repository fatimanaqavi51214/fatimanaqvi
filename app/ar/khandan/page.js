    ...
    <div className="container">
      ...
      <div className="family-bio-section" style={{ marginTop: '50px', padding: '30px', background: 'rgba(255,255,255,0.03)', borderRadius: '15px', border: '1px solid rgba(255,255,255,0.1)' }}>
        <p style={{ fontSize: '1.15rem', lineHeight: '2.2', textAlign: 'justify', color: '#e0e0e0', margin: 0 }}>
          ولدت السيدة نصرت فاطمة نقوي عام 1958 في مدينة كراتشي بباكستان. والدها هو السيد محمد نقوي ووالدتها هي مهر بانو. ولدت نصرت فاطمة في أسرة متعلمة وملتزمة، وعقدت العزم منذ البداية على التقدم في مجالات العلم والعمل، ولا تزال تنشط بنفس الحماس حتى اليوم. كان زوجها المرحوم غلام سرور تشودري، الذي توفي في 31 أكتوبر 2005 في لاهور. أبناؤها هم هاجرة خاتون تشودري، جواد حيدر تشودري، وفؤاد حيدر تشودري. عنوانها الدائم في باكستان هو غولبرغ 3، لاهور. كان لزوجها ثقة كبيرة في قدراتها الإدارية لدرجة أنه منحها في عام 2004 توكيلاً قانونياً كاملاً (توكيل خاص) لإدارة الأعمال وتعليم الأطفال وشؤون السفر.
        </p>
      </div>
    </div>
  );
