    ...
    <div className="container ayuda-page-wrapper">
      ...
      <section className="hero-modern" style={{ padding: '40px 20px 20px' }}>
        <div className="hero-content">
          <h1 className="hero-title">نصرت فاطمة نقوي</h1>
          <h2 className="hero-subtitle" style={{ marginTop: '10px', color: '#55efc4' }}>(محامية الإنسانية)</h2>
          <p className="hero-desc" style={{ marginTop: '15px', fontSize: '1.2rem' }}>نضال مستمر في خدمة الإنسانية</p>
        </div>
      </section>
      ...
      <section className="video-section" style={{ padding: '40px 20px', background: 'rgba(255,255,255,0.02)' }}>
        <h2 className="section-title glow-text text-center" style={{ marginBottom: '30px' }}>مقدمة فيديو أيودا</h2>
        <div className="video-container-modern" style={{ maxWidth: '1000px', margin: '0 auto', borderRadius: '15px', overflow: 'hidden', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
          <video 
            src="https://res.cloudinary.com/b7xbeztp/video/upload/v1789896189/saday-e-khalq-arabic.webm" 
