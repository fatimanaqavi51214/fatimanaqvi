  ...
  const familyMembers = [
    {
      ...
      details: [
        { label: "Father's Name", value: 'Late Syed Muhammad Naqvi' },
        { label: "Mother's Name", value: 'Late Mehr Bano' },
        { label: 'Date of Birth', value: '01/01/1958' },
        { label: 'Residence', value: 'UK' }
      ]
    },
    {
      name: 'Late Syed Muhammad Naqvi',
      relation: 'Father',
    ...
    {
      name: 'Late Ghulam Sarwar Chaudhry',
      relation: 'Husband',
    ...
    },
    {
      ...
      image: null,
      details: [
        { label: "Father's Name", value: 'Late Ghulam Sarwar Chaudhry' },
    ...
    <div className="container">
      ...
      <div className="family-bio-section" style={{ marginTop: '50px', padding: '30px', background: 'rgba(255,255,255,0.03)', borderRadius: '15px', border: '1px solid rgba(255,255,255,0.1)' }}>
        <p style={{ fontSize: '1.15rem', lineHeight: '2.2', textAlign: 'justify', color: '#e0e0e0', margin: 0 }}>
          Madam Nusrat Fatima Naqvi was born in 1958 in Karachi, Pakistan. Her father's name is Late Syed Muhammad Naqvi and her mother's name is Late Mehr Bano. Born into an educated and practicing family, Nusrat Fatima had a firm resolve from the very beginning to advance in the fields of knowledge and action, and she continues to be actively engaged with the same enthusiasm today. Her husband was the late Ghulam Sarwar Chaudhry, who passed away on October 31, 2005, in Lahore. Her children include Hajra Khatoon Chaudhry, Jawad Haider Chaudhry, and Fawad Haider Chaudhry. Her permanent address in Pakistan is Gulberg III, Lahore. Her husband had such confidence in her administrative abilities that in 2004, he granted her full legal authority (Special Power of Attorney) to manage the business, children's education, and travel matters.
        </p>
      </div>
    </div>
  );
